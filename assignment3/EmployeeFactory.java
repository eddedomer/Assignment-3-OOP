...
public abstract class EmployeeFactory {
    ...
    static public Employee createEmployee(String employeeID, String name, double grossSalary)
            throws InvalidEmployeeDataException {
        return new Employee(employeeID, name, grossSalary);
    }

    static public Employee createIntern(String employeeID, String name, double grossSalary, int GPA)
            throws InvalidEmployeeDataException {
        return new Intern(employeeID, name, grossSalary, GPA);
    }

    static public Employee createManager(String employeeID, String name, double grossSalary, String degree)
            throws InvalidEmployeeDataException {
